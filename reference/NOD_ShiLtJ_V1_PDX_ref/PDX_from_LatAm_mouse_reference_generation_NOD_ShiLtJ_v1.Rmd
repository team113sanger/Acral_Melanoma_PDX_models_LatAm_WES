...
```{r, nod_shilt_v3_report, echo=TRUE, message=FALSE, warning=FALSE }
...
``` {bash, FASTA_downloading, echo=TRUE, results=FALSE, eval=params$generate, class.source = "fold-show", message=FALSE, warning=FALSE }
...
suppressWarnings(dir.create(final_ref_genome_dir, recursive = T))
...
+ **FASTA file full path:** `r paste0(file.path(final_ref_genome_dir, "genome.fa"))`
+ **Annotation GTF file full path:** `r paste0(file.path(final_ref_genome_dir, pdx_annot_name))`
