...
fqfolder<-file.path(projectdir,"data", "fastqs")
logfolder<-file.path(projectdir, "logs")
fqlogfolder<-file.path(projectdir, "logs", "cramtofastqs")


#Make the folders
dir.create(fqfolder, recursive = TRUE)
